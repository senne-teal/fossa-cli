...
$latestUri = "$github/senne-teal/fossa-cli/releases/$releaseTag"
...
$downloadUri = "$github/senne-teal/fossa-cli/releases/download/$releaseVersion/$($app)_$($releaseVersionSemver)_windows_amd64.zip"
